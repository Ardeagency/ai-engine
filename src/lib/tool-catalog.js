...
const TOOL_EXAMPLES = {
  ...
  getBrandKit:           { group: "Generacion de archivos", ex: `[[TOOL:getBrandKit]]  → identidad visual de la marca (colores, fuentes, logo, tono, tagline) para DISEÑAR archivos a medida. Llamala ANTES de createArtifact con html. Ver skill diseno-creacion-archivos.` },
  createArtifact:        { group: "Generacion de archivos", ex: `[[TOOL:createArtifact|params:{"type":"presentation","title":"Estado de Marca","html":"<!DOCTYPE html>...documento completo...","reason":"informe pedido"}]]  → GENERA UN ARCHIVO descargable. MODO DISEÑADORA (recomendado): 1) getBrandKit, 2) diseña el documento HTML5 completo y a medida con la identidad de la marca (skill diseno-creacion-archivos: bespoke, NO plantilla; sin overflow; sin slides vacios; contraste; datos como tablas/cards), 3) pasalo en params.html — se renderiza tal cual (PDF, o PNG si type=infographic) con auto-fit anti-recorte. type: report|analysis|presentation|infographic|document|table. Sin html: usa content=markdown (plantilla basica) o data para table/infographic. Devuelve URL de descarga: SIEMPRE compartela.` },
