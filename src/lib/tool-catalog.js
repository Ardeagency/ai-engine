...
const TOOL_EXAMPLES = {
  ...
  generateVideoDirect:{ group: "Generacion de archivos", ex: `[[TOOL:generateVideoDirect|params:{"prompt":"Plano medio de una taza humeante sobre una mesa de madera junto a una ventana lluviosa, la camara hace un dolly-in lento, luz gris difusa de tarde, vapor visible a contraluz, ambiente calido y silencioso","aspect_ratio":"16:9"}]]  -> ARRANCA una generacion de video REAL (KIE). **TU ESCRIBES EL PROMPT FINAL: ya NO hay un modelo intermedio que lo reescriba.** Describe el plano completo: sujeto, accion, movimiento de camara, ambiente, luz y estilo. Campos: prompt (OBLIGATORIO, 10-5000 chars) · aspect_ratio 16:9|9:16|1:1 (default 16:9). ASINCRONA: devuelve rapido con status:"generating" + task_id real; el SISTEMA entrega el video en la conversacion cuando exista. Tu respuesta: 1 linea de que lo estas generando y que aparecera aqui. PROHIBIDO inventar URL o decir que ya esta. ANTES SIEMPRE PREGUNTA "yo directo o un flujo de la biblioteca?". OJO: el proveedor tiene su modelo de video PAUSADO de su lado por temporadas; si te responde eso, no es tu prompt y no hay nada que reintentar.` },
